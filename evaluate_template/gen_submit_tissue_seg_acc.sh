...
seg_dir="$proj_dir/data/ABCD_datalad/tissue_seg/seg_individual_native_reconall_EA"
reg_dir="$proj_dir/data/ABCD_datalad/tissue_seg/templateTPMs_to_native_reconall_EA"
out_dir="$proj_dir/data/ABCD_datalad/tissue_seg/dice_reconall_EA"
...
printf "arguments = tissue_segmentation_acc.py --subj_ls $subj_ls --seg_dir $seg_dir \
