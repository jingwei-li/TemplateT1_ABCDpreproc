...
for grp in AA EA; do
    ...
    for s in $(cat $subj_ls); do
        ref_dir="$proj_dir/data/ABCD_datalad/tissue_seg/seg_individual_native/$s"
        out_dir="$proj_dir/data/ABCD_datalad/tissue_seg/templateTPMs_to_native/Template_912$grp/$s"
