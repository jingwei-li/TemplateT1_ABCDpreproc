...
for eth in AA EA; do
    ...
    flirt -in $TPL_DIR/tpl-PNC${eth}${age_min}${age_max}/tpl-PNC${eth}${age_min}${age_max}_res-01_T1w.nii.gz \
        -ref $TPL_DIR/tpl-PNC${eth}${age_min}${age_max}/tpl-PNC${eth}${age_min}${age_max}_res-01_T1w.nii.gz \
        -applyisoxfm 1 -nosearch \
        -out $TPL_DIR/tpl-PNC${eth}${age_min}${age_max}/tpl-PNC${eth}${age_min}${age_max}_res-02_T1w.nii.gz

    flirt -in $TPL_DIR/tpl-PNC${eth}${age_min}${age_max}/tpl-PNC${eth}${age_min}${age_max}_res-01_desc-brain_mask.nii.gz \
        -ref $TPL_DIR/tpl-PNC${eth}${age_min}${age_max}/tpl-PNC${eth}${age_min}${age_max}_res-01_desc-brain_mask.nii.gz \
        -applyisoxfm 1 -nosearch \
        -out $TPL_DIR/tpl-PNC${eth}${age_min}${age_max}/tpl-PNC${eth}${age_min}${age_max}_res-02_desc-brain_mask.nii.gz
    
    mri_binarize --i $TPL_DIR/tpl-PNC${eth}${age_min}${age_max}/tpl-PNC${eth}${age_min}${age_max}_res-02_desc-brain_mask.nii.gz \
        --o $TPL_DIR/tpl-PNC${eth}${age_min}${age_max}/tpl-PNC${eth}${age_min}${age_max}_res-02_desc-brain_mask.nii.gz --min 0.4999
